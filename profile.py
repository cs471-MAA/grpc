"""Docker swarm topology in a lan. Based on PortalProfiles/small-lan topology.
...
imageList = [
    ...
    ('urn:publicid:IDN+apt.emulab.net+image+cloudsuite3-PG0:docker-swarm', 'UBUNTU 20.04')]
